...
export default function HealthCare() {
  ...
  // Fetch baby health care data
  useEffect(() => {
    fetch("/BabyHealthCare.json")
      .then(res => res.json())
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      <h1 className="text-3xl font-bold text-center mb-6">Baby Health Care</h1>

      {/* Search */}
      <div className="relative mb-4">
        <input
          type="text"
          placeholder="Search baby health items..."
